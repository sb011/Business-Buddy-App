...
class AddUsersToInventoryPage extends StatefulWidget {
  ...
  @override
  State<AddUsersToInventoryPage> createState() => _AddUsersToInventoryPageState();
}
    ...
    for (int i = 0; i < _userControllers.length; i++) {
      ...
      if (mobileNumber == null || mobileNumber.isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Please enter mobile number for user ${i + 1}')),
        );
        return;
      }
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextField(
                            controller: _userControllers[index]['mobileNumber'],
